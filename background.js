...
// the QUOTA BYTES PER ITEM from chrome storage
...
// Retrieve the watching anime list from each part on the chrome storage
...
// Retrieve the to_watch list from each part on the chrome storage and create a
